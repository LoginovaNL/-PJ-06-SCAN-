...
const UserBlock = ({ isSuccessfulAuthorization, userName, userPicture, setUserName, setUserPicture, isMobile, isMenuVisible }) => {
    ...
    return (
        <div className="user-blocks">
            ...
            {isMobile && isSuccessfulAuthorization && !isMenuVisible && (
